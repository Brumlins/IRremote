...
#define redLed 5 // Pin pro červenou barvu
#define greenLed 6 // Pin pro zelenou barvu
#define blueLed 9 // Pin pro modrou barvu 

String stringNum = "";
int currentLED = 0; // 0 = červená, 1 = zelená, 2 = modrá
...
int codesSize = sizeof(codes) / sizeof(codes[0]); // Zjištění počtu prvků v poli
